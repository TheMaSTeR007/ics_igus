        ...
        for this_category_data in categories_data:
            ...
            if category_id:
                ...
                for page_no in range(1, page_count + 1):
                    ...
                    category_page = self.page_checker(url=category_link, method='GET', directory_path=os.path.join(self.project_files_dir, 'Products_Pages'))
            ...
            # As pre-assembled-cable-carriers does not have products on its page, ignoring it manually
                ...
                print('REAMAINING', category_link)
