...
class Scraper:
    ...
    def scrape(self):
        ...
        #     end_index_catId = script_text_catID.find(__sub='";', __start=start_index_catId)
        ...
        #             category_page = self.page_checker(url=category_link, method='GET', directory_path=os.path.join(self.project_files_dir, 'Products_Pages'), page_hash=)
        ...
        #                     product_page = self.page_checker(url=product_link, method='GET', directory_path=os.path.join(self.project_files_dir, 'Product_Variant_Pages'), page_hash=)
        ...
        #             print(category_link)
        #             category_page = page_checker_json_new(url=category_link, method='GET', directory_path=os.path.join(self.project_files_dir, 'Products_Pages_Json')asdokn)
        #
        ...
        #     update_query_category_status = f'''UPDATE `{table_name}` SET category_status = 'Done' WHERE id = {category_index_id_};'''
        #     self.cursor.execute(update_query_category_status)
        #     print('-' * 100)
